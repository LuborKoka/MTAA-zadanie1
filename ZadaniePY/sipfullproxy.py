    ...
    def processNonInvite(self):
        ...
        if len(destination) > 0:
            ...
            if destination in registrar and self.checkValidity(destination):
                ...
                self.sendResponse("406 Neakceptovatlne")
        else:
            self.sendResponse("500 Server Internal Error") #jako toto nejdem prepisovat
...
def start(HOST, PORT):
    ...
    print("SIP server is now running")
